...
import com.tinkoff.edu.app.loan.repository.impl.FileLoanCalcRepository;
...
public class FileAppTest {
    private FileLoanCalcRepository fileRepository;
    ...
    @BeforeEach
    public void init() {
        fileRepository = new FileLoanCalcRepository();
        fileRepository.clearFile();
        service = new LoanCalcService(fileRepository);
